...
public class ManagerStoryController extends HttpServlet {
    ...
    private void handleListWithFilters(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("view/dashboard/admin/slider_list.jsp").forward(request, response);
    }
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response)
        ...
        if (storyIdStr != null && !storyIdStr.isEmpty()) {
            ...
            if (story != null) {
                ...
                request.getRequestDispatcher("view/dashboard/admin/slider_details.jsp").forward(request, response);
                return;
            }
        }
    ...
    private void showAddForm(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("view/dashboard/admin/slider_add.jsp").forward(request, response);
    }
