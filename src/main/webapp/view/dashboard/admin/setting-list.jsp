                    ...
                    <div class="d-flex align-items-center flex-wrap gap-3"> 
                        <form action="${pageContext.request.contextPath}/manage-settings" method="GET" class="d-flex align-items-center gap-3">
                            ...
                            <select class="form-select form-select-sm w-auto ps-12 py-6 radius-12 h-40-px" name="type">
                                ...
                                <option value="Notification" ${param.type == 'Notification' ? 'selected' : ''}>Notification</option>
                            </select>
                            ...
                            <tbody>
                                <c:forEach var="setting" items="${settings}">
                                    <tr>
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${setting.key eq 'password' || setting.key eq 'app_password' || setting.key eq 'secret_key'}">
                                                    ******
                                                </c:when>
                                                <c:otherwise>
                                                    ${setting.value}
