...
<html class="no-js" lang="en">
    ...
    <body>
                                ...
                                <div class="product-more-views">
                                    <div class="tab_thumbnail" data-tabs="tabs">
                                        <div class="thumbnail-carousel">
                                            <ul class="nav">
                                                <li>
                                                    <a class="active" href="#view11" data-bs-toggle="tab">
                                ...
                                <div class="tab-content active-portfolio-area pos-rltv">                                       
                                    <div role="tabpanel" class="tab-pane active" id="view11">
                                        <div class="product-img">
                                            <a class="fancybox" data-fancybox-group="group" href="${thumbnail}">
                                                <img src="${thumbnail}" alt="Product Image" />
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="sp-bottom-des">
                                    ...
                                    <form action="cart" method="post" class="add">
                                        ...
                                        <div class="action-buttons">
                                            ...
                                            <a href="${pageContext.request.contextPath}/products" class="btn btn-lg btn-outline-secondary">
                                                Continue shopping
                                            </a>
                                        </div>
                                    </form>
        ...
        <jsp:include page="../common/home/js-home.jsp"></jsp:include>
            ...
            <script>
                document.querySelector('form.add').addEventListener('submit', function () {
                ...
                window.addEventListener('DOMContentLoaded', function() {
                    var colorSelect = document.getElementById('input-sort-color');
                    if (colorSelect && colorSelect.options.length > 0) {
                        colorSelect.value = colorSelect.options[0].value;
                    }
                    var sizeSelect = document.getElementById('input-sort-size');
                ...
                document.querySelectorAll('.qtybutton').forEach(function(button) {
                    button.addEventListener('click', function(event) {
                        ...
                        var input = document.getElementById('visible-quantity');
